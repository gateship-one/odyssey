...
public class AlbumLoader extends AsyncTaskLoader<List<AlbumModel>> {
    ...
    public List<AlbumModel> loadInBackground() {
        ...
        if (mArtistID == -1) {
            ...
            albumCursor = PermissionHelper.query(mContext, MediaStore.Audio.Artists.Albums.getContentUri("external", mArtistID), MusicLibraryHelper.projectionAlbums, "", null, MediaStore.Audio.Albums.ALBUM + " COLLATE NOCASE");
        }
