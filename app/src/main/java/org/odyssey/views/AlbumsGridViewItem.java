...
public class AlbumsGridViewItem extends RelativeLayout implements GenericGridItem{
    ...
    public AlbumsGridViewItem(Context context, String title, String imageURL, ViewGroup.LayoutParams layoutParams) {
        ...
        mHolder.coverViewReference = new WeakReference<ImageView>((ImageView) this.findViewById(R.id.item_albums_cover_image));
        mHolder.coverViewSwitcher = new WeakReference<ViewSwitcher>((ViewSwitcher) this.findViewById(R.id.item_albums_view_switcher));
        mHolder.imagePath = imageURL;

        mSwitcher = (ViewSwitcher) this.findViewById(R.id.item_albums_view_switcher);
        mImageView = (ImageView) this.findViewById(R.id.item_albums_cover_image);
    }
