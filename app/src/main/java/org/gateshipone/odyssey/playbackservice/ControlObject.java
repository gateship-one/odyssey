...
public class ControlObject {
    public enum PLAYBACK_ACTION {
        ...
        ODYSSEY_ENQUEUETRACK, ODYSSEY_ENQUEUETRACKS, ODYSSEY_DEQUEUETRACK, ODYSSEY_DEQUEUETRACKS, ODYSSEY_SETNEXTRACK,
        ODYSSEY_SHUFFLEPLAYLIST, ODYSSEY_PLAYALLTRACKS, ODYSSEY_PLAYALLTRACKSSHUFFLED,
        ODYSSEY_RESUMEBOOKMARK, ODYSSEY_DELETEBOOKMARK, ODYSSEY_CREATEBOOKMARK,
        ODYSSEY_SAVEPLAYLIST, ODYSSEY_CLEARPLAYLIST, ODYSSEY_ENQUEUEPLAYLIST, ODYSSEY_ENQUEUEPLAYLISTFILE,
        ODYSSEY_ENQUEUEFILE, ODYSSEY_ENQUEUEDIRECTORY, ODYSSEY_ENQUEUEDIRECTORYANDSUBDIRECTORIES,
        ODYSSEY_ENQUEUEALBUM, ODYSSEY_ENQUEUEARTIST, ODYSSEY_ENQUEUERECENTALBUMS
    }
